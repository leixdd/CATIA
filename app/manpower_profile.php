...
class manpower_profile extends Model
{
    ...
    protected $fillable = ['id', 'image_href', 'entry_date', 'last_name', 'first_name', 'middle_name', 'num_street', 'barangay', 'district', 'city', 'province', 'region', 'email', 'contact', 'nationality','payment'];
