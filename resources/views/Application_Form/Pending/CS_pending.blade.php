...
<div class="panel panel-primary">
    ...
    {!! Form::open(['url' => '/search', 'class' => 'form-horizontal']) !!}
      <div class="col-lg-6">
        <div class="form-group">
          ...
          {!! Form::hidden('path', $value = "Pending/CS_pending", $attributes = ['class' => 'form-control', 'name' => 'path']) !!}
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      ...
      @else
        <h1 style="padding-top: 25px; margin-bottom: 2%;"><b><span style="color: #209eeb;">| </span>List of all clients</b></h1>
  ...
  <div id="pdb" class="">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-offset-1" style="margin-bottom: 3%;">
          <b style="font-size: 16pt">Computer Systems Servicing NCII - Pending Applicants</b>
      </div>
    </div>
