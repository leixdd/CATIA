...
<div class="panel panel-primary">
    ...
    {!! Form::open(['url' => '/search', 'class' => 'form-horizontal']) !!}
      <div class="col-lg-6">
        <div class="form-group">
          ...
          {!! Form::hidden('path', $value = "Confirm/view_confirm_CS", $attributes = ['class' => 'form-control', 'name' => 'path']) !!}
          {!! Form::hidden('accessx', $value = 1, $attributes = ['class' => 'form-control', 'name' => 'accessx']) !!}
        </div>
        <div class="form-group">
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">List of Confirm Applicants</div>
    <div class="panel-body">
    ...
    <div id="pdb" class="">
      <div class="row">
        ...
        <div class="col-lg-12 col-md-offset-1" style="margin-bottom: 3%;">
            <b style="font-size: 16pt">Computer Systems Servicing NCII - Confirm Applicants</b>
        </div>
      </div>
