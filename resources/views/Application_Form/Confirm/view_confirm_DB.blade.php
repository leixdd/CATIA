    ...
    {!! Form::open(['url' => '/search', 'class' => 'form-horizontal']) !!}
      <div class="col-lg-6">
        <div class="form-group">
          ...
          {!! Form::hidden('path', $value = "Confirm/view_confirm_DB", $attributes = ['class' => 'form-control', 'name' => 'path']) !!}
    ...
    <div id="pdb" class="">
      <div class="row">
        ...
        <div class="col-lg-12 col-md-offset-1" style="margin-bottom: 3%;">
            <b style="font-size: 16pt">Database Mgmt. and App. Prog. - Confirm Applicants</b>
        </div>
      </div>
