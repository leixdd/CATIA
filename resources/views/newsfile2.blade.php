...
@section('content')
<section class="container-size-150 container-color-white lightx" >
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<div class="text-left wow fadeInUp split-top">
					<h1 class="newsheader-text-style"><font class="newsline-text-style">|</font>TESDA, MSU ink agreement to combat poverty in Mindanao</h1>
				</div>
			</div>
		</div>
		<div class="row text-justify split-top split-side">
			<div class="col-lg-12">
				<img class="img-responsive" src="images/CATIA_NEWS/2.jpg">
			</div>
			<div class="col-lg-12 split-top">
				<p>On behalf of TESDA Secretary Guiling “Gene” A. Mamondiong, Deputy Director General for Policies and Planning Rosanna A. Urdaneta led a press conference today, July 27, and presented the Agency’s long term plans for thwarting poverty by increasing the marginalized sector’s access to technical vocational education and training (TVET).<br><br>

				Executive Director Marissa Legaspi of the TESDA Planning Office shared with media the Authority’s “Two-pronged Strategy of TESDA in Poverty Reduction”, which are the TVET for Global Competitiveness and TVET for Social Equity, that plans to offer more training services to urban and rural poor, farmers, fisher folks, indigenous people (IPs), women, rebel returnees/combatants, drug dependents, repatriated OFWs, out-of-school youths (OSYs), micro, small and medium enterprises (MSMEs), family enterprises, and local government units (CTECs).<br><br>
				...
				DDG Urdaneta clarified that aside from the training given by more than 4,000 TVET providers in the country, TESDA plans to bolster its training efforts using approaches such as community-based training, expanded scholarships, Mobile Training Program, TESDA Online Program, Barangay Empowerment thru TVET, CMUs (Compact Mobile Units) and Onsite Training and Assessment.<br><br>
