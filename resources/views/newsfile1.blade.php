		...
		<div class="row">
			<div class="col-lg-12">
				<div class="text-left wow fadeInUp split-top">
					<h1 class="newsheader-text-style"><font class="newsline-text-style">|</font>TESDA unveils plans for poverty reduction</h1>
				</div>
			</div>
		</div>
		<div class="row text-justify split-top split-side">
			<div class="col-lg-12">
				<img class="img-responsive" src="images/CATIA_NEWS/1.jpg">
			</div>
