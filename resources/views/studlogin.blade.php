...
<html lang="en">
<head>
	<title>Catia Student:Login</title>
	<meta charset="utf-8">
...
<body>
	<section id="studlog"> <!-- HOME Section <img src="/images/CATIA_IMAGES/catialogo.png" style="position: absolute; left: 29px;top:45px;"> -->
		<div class="studlogin">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="text-left wow fadeInUp lightx" style="padding-top: 40px;">
							<h1 style="font-size: 36pt; font-weight: bold;"><font style="font-size: 50pt; font-weight: bold; color: #209eeb">|</font>Welcome Students! Login:</h1>
						</div>
					</div>
				</div>
			</div>
